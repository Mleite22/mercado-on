<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
                ...
                <img alt="image" src="{{ asset(Auth::user()->image) }}" class="rounded-circle mr-1" title="{{ Auth::user()->name }}">
                @else
                <img alt="image" src="{{ asset('backend/assets/img/avatar/avatar-1.png') }}" class="rounded-circle mr-1" title="{{ Auth::user()->name }}">
                @endif
